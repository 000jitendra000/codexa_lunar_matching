"""
Helper script: writes experiments/run_classical_baseline.py
Run once from project root: python gen_experiment.py
"""
import pathlib

CONTENT = r"""import os, sys, json, logging
import numpy as np
import cv2
...
pathlib.Path("experiments/run_classical_baseline.py").write_text(CONTENT, encoding="utf-8")
print("Written experiments/run_classical_baseline.py OK")
